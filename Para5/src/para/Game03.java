...
public class Game03 {
  // final JavaFXTarget jf = new JavaFXTarget("Game03", 1840, 960);
  final JavaFXTarget jf = new JavaFXTarget("BreakOut", 1840, 960, 1840, 990);
  final MainParser ps;
  ...
  public void start(String args0, int level) {
    ...
    jf.addKeyPressHandler(ev -> {
      if(ev.getCode() == KeyCode.F || ev.getCode() == KeyCode.LEFT){
        wall.remove(10);
        mybar_x = mybar_x - 20;
        wall.add(new Rectangle(10,mybar_x, mybar_y, 240, 20, wallattr));
      }
      else if(ev.getCode() == KeyCode.J || ev.getCode() == KeyCode.RIGHT){
        wall.remove(10);
        mybar_x = mybar_x + 20;
        wall.add(new Rectangle(10,mybar_x, mybar_y, 240, 20, wallattr));
      }
      else if(ev.getCode() == KeyCode.T || ev.getCode() == KeyCode.Y || ev.getCode() == KeyCode.U || ev.getCode() == KeyCode.UP){
        wall.remove(10);
        mybar_y = mybar_y - 20;
        wall.add(new Rectangle(10,mybar_x, mybar_y, 240, 20, wallattr));
      }
      else if(ev.getCode() == KeyCode.V || ev.getCode() == KeyCode.B || ev.getCode() == KeyCode.N || ev.getCode() == KeyCode.DOWN){
        wall.remove(10);
        mybar_y = mybar_y + 20;
        wall.add(new Rectangle(10,mybar_x, mybar_y, 240, 20, wallattr));
      }
  ...
  public static void main(String[] args) {
    Game03 game03 = new Game03(args[0]);
    game03.init();
    game03.ready(args[0]);
  }
}
